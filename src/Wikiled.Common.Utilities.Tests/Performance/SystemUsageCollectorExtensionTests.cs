...
namespace Wikiled.Common.Utilities.Tests.Performance
{
    ...
    {
        [TestCase(120, 55.5555, 44.444, "Working Set: 0.12 KB Total CPU Used: 55.56 User CPU: 44.44")]
        [TestCase(12000, 55.5555, 44.444, "Working Set: 11.72 KB Total CPU Used: 55.56 User CPU: 44.44")]
        [TestCase(1024 * 1024 * 56, 55.5555, 44.444, "Working Set: 56.00 MB Total CPU Used: 55.56 User CPU: 44.44")]
        [TestCase(1024L * 1024 * 1024 * 56, 55.5555, 44.444, "Working Set: 56.00 GB Total CPU Used: 55.56 User CPU: 44.44")]
